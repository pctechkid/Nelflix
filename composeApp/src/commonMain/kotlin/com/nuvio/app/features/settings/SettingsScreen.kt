    ...
    BoxWithConstraints(
        ...
        if (maxWidth >= 768.dp) {
            TabletSettingsScreen(
                ...
                mpvDemuxerMaxBytesMiB = playerSettingsUiState.mpvDemuxerMaxBytesMiB,
                ...
                homescreenShowCatalogTypeLabels = homescreenSettingsUiState.showCatalogTypeLabels,
...
private fun MobileSettingsScreen(
    ...
    homescreenShowCatalogTypeLabels: Boolean,
        ...
        NuvioScreen(
            ...
            when (page) {
                ...
                SettingsPage.Homescreen -> homescreenSettingsContent(
                    ...
                    showCatalogTypeLabels = homescreenShowCatalogTypeLabels,
