...
class PlayerSettingsDefaultsTest {
    ...
    fun defaultMpvConfigPreservesAssPlacementWithOriginalOpaqueBox() {
        ...
        assertContains(DefaultMpvConf.lineSequence().toList(), "demuxer-max-bytes=256MiB")
        assertContains(DefaultMpvConf.lineSequence().toList(), "demuxer-max-back-bytes=64MiB")
